#!/usr/bin/env python3
"""Create a labeled contact sheet from a Feishu Pet atlas."""
...
def main():
    ...
    for row in range(ROWS):
        ...
        draw.text((width - 92, y + 5), f"{USED_COUNTS[row]} frames", fill="#ffffff", font=font)
    ...
    print(f"[contact_sheet] 已生成: {output}")
